...
CREATE ALIAS GET_PAID_ORDER_TOTAL_FROM_CUSTOMER FOR "com.pluralsight.order.util.H2StoredProcedures.getPaidOrderTotalFromCustomer";
CREATE ALIAS MULT FOR "com.pluralsight.order.util.H2StoredProcedures.mult";
